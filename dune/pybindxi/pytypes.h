...
#if defined(_MSC_VER)
#  pragma warning(push)
#  pragma warning(disable : 4275 4251) // warning C4275: An exported class was derived from a class that wasn't
...
public:
  ...
  error_already_set()
    : std::runtime_error(detail::error_string())
  {
...
public:
  ...
  // 'explicit' is explicitly omitted from the following constructors to allow implicit conversion to py::str from C++
  // string-like objects
  str(const char* c = "")
