...
template <class DomainFieldImp, int domainDim, class RangeFieldImp, class ParamFieldImp, int maxParamDim>
class Interface<DomainFieldImp, domainDim, RangeFieldImp, 1, ParamFieldImp, maxParamDim>
{
public:
  typedef Interface<DomainFieldImp, domainDim, RangeFieldImp, 1, ParamFieldImp, maxParamDim> ThisType;
