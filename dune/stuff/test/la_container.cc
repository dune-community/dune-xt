...
template <class S>
class ContainerFactory<CommonDenseVector<S>>
{
public:
...
template <class S>
class ContainerFactory<CommonDenseMatrix<S>>
{
public:
...
#if HAVE_DUNE_ISTL
template <class S>
class ContainerFactory<IstlDenseVector<S>>
{
public:
...
template <class S>
class ContainerFactory<IstlRowMajorSparseMatrix<S>>
{
public:
...
#if HAVE_EIGEN
template <class S>
class ContainerFactory<EigenDenseVector<S>>
{
public:
...
template <class S>
class ContainerFactory<EigenMappedDenseVector<S>>
{
public:
...
template <class S>
class ContainerFactory<EigenDenseMatrix<S>>
{
public:
...
template <class S>
class ContainerFactory<EigenRowMajorSparseMatrix<S>>
{
public:
...
struct ContainerTest : public ::testing::Test
{
  void fulfills_interface() const
  {
    ...
    ContainerImp d_by_size = Stuff::LA::ContainerFactory<ContainerImp>::create(dim);
