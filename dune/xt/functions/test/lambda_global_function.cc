...
struct GlobalLambdaFunctionTest : public FunctionTest<TESTFUNCTIONTYPE>
{
  virtual void check() const
  {
    const FunctionType zero(
        [](DomainType /*x*/, const Common::Parameter& /*mu*/ = Common::Parameter()) { return RangeType(0); }, 0);
    const FunctionType one(
        [](DomainType /*x*/, const Common::Parameter& /*mu*/ = Common::Parameter()) { return RangeType(1); }, 0);
