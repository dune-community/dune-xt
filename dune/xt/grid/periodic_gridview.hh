...
public:
    ...
    , real_index_set_(BaseType::indexSet())
  {
    ...
    entity_counts_[0] = real_grid_view.indexSet().size(0);
...
private:
  static std::map<IndexType, IntersectionMapType> entity_to_intersection_map_map_;
  static std::vector<IndexMapType> index_maps_;
