...
void addbind_WhichIntersection(pybind11::module& m, const std::string& grid_id, const std::string& layer)
{
  ...
  internal::
      bind_WhichIntersection<ApplyOn::AllIntersections<GV>, BoundaryInfo<typename Intersection<GV>::type>, false>()(
          m, "ApplyOnAllIntersections__" + grid_id + "_" + layer, "make_apply_on_all_intersections__" + layer);

  internal::
      bind_WhichIntersection<ApplyOn::InnerIntersections<GV>, BoundaryInfo<typename Intersection<GV>::type>, false>()(
  ...
  internal::
      bind_WhichIntersection<ApplyOn::NeumannIntersections<GV>, BoundaryInfo<typename Intersection<GV>::type>, true>()(
