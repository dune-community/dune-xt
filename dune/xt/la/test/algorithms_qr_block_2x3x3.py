...
common_types = [f.split('_') for f in ['FieldMatrix_FieldVector_FieldVector_double,6,6',
...
dune_types = [f.split('_') for f in ['FieldMatrix_FieldVector_FieldVector_double,6,6',
