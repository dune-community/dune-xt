...
matrix = EigenDenseMatrix<double>, FieldMatrix<double\, 6\, 6> | expand types
matrix_short = eigendense_double, fieldmatrix_double | expand types
complex_matrix = EigenDenseMatrix<std::complex<double>>, FieldMatrix<std::complex<double>\, 6\, 6> | expand types
real_matrix = EigenDenseMatrix<double>, FieldMatrix<double\, 6\, 6> | expand types
