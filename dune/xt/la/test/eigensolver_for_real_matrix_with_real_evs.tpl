...
{
  gives_correct_eigenvectors_in_correct_order( { {"qr_fallback", /*we_expect_a_failure: */ "-1"} } );
}

TEST_F(EigenSolverForMatrixFullOfOnes_{{T_NAME}}, gives_correct_real_eigenvectors_in_correct_order)
{
  gives_correct_real_eigenvectors_in_correct_order( { {"qr_fallback", /*we_expect_a_failure: */ "-1"} } );
}
