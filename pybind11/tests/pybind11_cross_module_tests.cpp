...
PYBIND11_MODULE(pybind11_cross_module_tests, m)
{
  ...
  // Local to both:
  bind_local<LocalType, 1>(m, "LocalType", py::module_local()).def("get2", [](LocalType& t) { return t.i + 2; });
  ...
  m.def("register_nonlocal_map2", [m]() { py::bind_map<NonLocalMap2>(m, "NonLocalMap2", py::module_local(false)); });
  ...
  m.def("load_vector_via_binding", [](std::vector<int>& v) { return std::accumulate(v.begin(), v.end(), 0); });
