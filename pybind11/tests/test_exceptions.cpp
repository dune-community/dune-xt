...
{
public:
  explicit MyException(const char* m)
    : message{m}
  {}
...
{
public:
  explicit MyException2(const char* m)
    : message{m}
  {}
  virtual const char* what() const noexcept override
  {
...
{
public:
  explicit MyException3(const char* m)
    : message{m}
  {}
...
{
public:
  explicit MyException4(const char* m)
    : message{m}
  {}
  virtual const char* what() const noexcept override
  {
...
{
public:
  explicit MyException5(const std::string& what)
...
{
  m.def("throw_std_exception", []() { throw std::runtime_error("This exception was intentionally thrown."); });
