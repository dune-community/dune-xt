...
#define MAKE_TAG_TYPE(Name)                                                                                            \
  ...
  py::class_<TestFactory4, TestFactory3, std::shared_ptr<TestFactory4>>(m, "TestFactory4").def(py::init(c4a)) // pointer
      ;
  ...
  py::class_<TestFactory7, PyTF7, std::shared_ptr<TestFactory7>>(m, "TestFactory7")
      ...
      .def(py::init([](mixed_tag, int i) { return new TestFactory7(i); }, [](mixed_tag, int i) { return PyTF7(i); }))
      ...
      .def(py::init([](shared_ptr_tag, invalid_base_tag, int i) { return std::make_shared<TestFactory7>(i); },
  ...
  py::class_<NoisyAlloc>(m, "NoisyAlloc")
      ...
      // single non-integer:
      .def("__init__", [](NoisyAlloc* a, int i) { new (a) NoisyAlloc(i); }) // Regular constructor, runs first, requires
                                                                            // preallocation
