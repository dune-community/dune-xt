...
TEST_SUBMODULE(local_bindings, m)
{
  ...
  bind_local<LocalType, -1>(m, "LocalType", py::module_local()).def("get3", [](LocalType& t) { return t.i + 3; });
  ...
  bind_local<NonLocalType, 0>(m, "NonLocalType").def(py::init<int>()).def("get", [](LocalType& i) { return i.i; });
  ...
  m.def("load_vector_via_caster", [](std::vector<int> v) { return std::accumulate(v.begin(), v.end(), 0); });
