...
TEST_SUBMODULE(methods_and_attributes, m)
{
  ...
  py::class_<TestProperties>(m, "TestProperties")
      ...
      .def_property_static("def_writeonly_static", nullptr, [](py::object, int v) { TestProperties::static_value = v; })
  ...
  py::class_<StrIssue>(m, "StrIssue").def(py::init<int>()).def(py::init<>()).def("__str__", [](const StrIssue& si) {
