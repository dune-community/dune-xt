...
TEST_SUBMODULE(sequences_and_iterators, m)
{
  ...
  {
  public:
    IntPairs(std::vector<std::pair<int, int>> data)
      : data_(std::move(data))
    {}
  ...
  m.def("count_none",
        [](py::object o) { return std::count_if(o.begin(), o.end(), [](py::handle h) { return h.is_none(); }); });
  ...
  m.def("count_nonzeros", [](py::dict d) {
    return std::count_if(
        d.begin(), d.end(), [](std::pair<py::handle, py::handle> p) { return p.second.cast<int>() != 0; });
  });
