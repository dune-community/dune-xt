...
TEST_SUBMODULE(smart_ptr, m)
{
  ...
  py::class_<SharedFromThisVirt, std::shared_ptr<SharedFromThisVirt>>(m, "SharedFromThisVirt").def_static("get", []() {
    return sft.get();
  });
  ...
  py::class_<C, custom_unique_ptr<C>>(m, "TypeWithMoveOnlyHolder").def_static("make", []() {
  ...
  {
    TypeForMoveOnlyHolderWithAddressOf(int value)
      : value{value}
    {
      print_created(this);
    }
