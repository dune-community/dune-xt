...
#
# All rights reserved. Use of this source code is governed by a BSD-style license that can be found in the LICENSE
# file.
...
if(NOT PYBIND11_CPP_STANDARD AND NOT CMAKE_CXX_STANDARD)
  ...
  set(PYBIND11_CPP_STANDARD ${PYBIND11_CPP_STANDARD}
      CACHE STRING "C++ standard flag, e.g. -std=c++11, -std=c++14, /std:c++14.  Defaults to C++14 mode."
      FORCE)
endif()
...
# Build a Python extension module: pybind11_add_module(<name> [MODULE | SHARED] [EXCLUDE_FROM_ALL] [NO_EXTRAS] [SYSTEM]
...
function(pybind11_add_module target_name)
  ...
  if(MSVC)
    ...
    if(CMAKE_VERSION VERSION_LESS 3.11)
      ...
      # types of source files like CUDA .cu files don't get these options propagated to nvcc since that would cause the
      # build to fail.
